...
function invalidateCacheItem(kittyId) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    dynamoDb.delete({ TableName: tableName, Key: { "kittyId": kittyId } }, function (err, data) {
                        if (err) {
                            reject(err);
                        }
                        else {
...
function default_1(event, context, callback) {
    return __awaiter(this, void 0, void 0, function () {
        var items, kittyId, err, response, deleteResult, response, err_1, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    items = [];
                    if (event.queryStringParameters && event.queryStringParameters.kittyId) {
                        ...
                        err = { message: 'kittyId URL parameter not defined' };
                        response = {
                            headers: {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, invalidateCacheItem(kittyId)];
                case 2:
...
//# sourceMappingURL=invalidateKittyId.js.map